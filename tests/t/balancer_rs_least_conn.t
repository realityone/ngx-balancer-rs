...
# Port of nginx-tests upstream_least_conn.t adapted for the
# `balancer_rs least_conn` directive. Same backends, same assertions —
# this exercises the actual selection algorithm (tie-break then
# least-conn fallback) rather than just the single-peer fast path.
